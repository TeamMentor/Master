openUrl = function(url, title, width, height)
{	
	if (typeof(title)=="undefined") title = url;
	if (typeof(width)=="undefined") width = 400;
	if (typeof(height)=="undefined") height = 400;

	var gDialog = jQuery.FrameDialog.create(
			{
				url:  url,
				title: title,
				width:  width,
	...
	var frameHeight = parseInt(gDialog.css('height'));
	gDialog.parent().css('height' , frameHeight + 32);
	return gDialog;
};

//openUrl('http://www.google.com', 'google', 400,400)
