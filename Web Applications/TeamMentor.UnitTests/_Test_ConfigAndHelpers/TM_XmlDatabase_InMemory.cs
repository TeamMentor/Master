...
{    
    public class TM_XmlDatabase_InMemory
    {
        ...
        {
            Install_LibraryFromZip("https://github.com/TeamMentor/Library_Top_Vulnerabilities/zipball/master");
        }        
        public void Install_LibraryFromZip_OWASP()
        {
            Install_LibraryFromZip("https://github.com/TeamMentor/OWASP_Library/zipball/master");
        }
        [Assert_Admin]
        public void Install_LibraryFromZip(string pathToGitHubZipBall)
        {
