...
namespace TeamMentor.CoreLib
{
    ...
    {
        [WebMethod(EnableSession = true)]	public Login_Response Login(string username, string password)      		        {   var response = userData.login(username,password); tmAuthentication.sessionID = response.Token; return response; }  			
