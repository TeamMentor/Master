...
namespace TeamMentor.UnitTests.Cassini
{
    public static class IE_TeamMentor_ExtensionMethods_Content
    {
        ...
        public static IE_TeamMentor article_Edit(this IE_TeamMentor ieTeamMentor, TeamMentor_Article tmArticle)
        {
            return ieTeamMentor.article_Edit(tmArticle.Metadata.Id);
        }
